    ...
    <div className="min-h-screen">
      ...
      <div className="pt-20 pb-16">
        <div className="max-w-4xl mx-auto px-4">
          <h1 className="text-4xl font-bold text-gray-800 mb-8">Teslimat ve İade</h1>
          
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h2 className="text-2xl font-bold mb-4">Teslimat Bilgileri</h2>
            <div className="space-y-3 text-gray-700 mb-6">
              <p>• Ürünleriniz sipariş onayından itibaren 1-3 iş günü içerisinde kargoya verilir.</p>
              <p>• Kargo firması tarafından teslimat yapılırken siz veya belirttiğiniz kişi bulunmazsa, kargo firması ile iletişime geçmeniz gerekmektedir.</p>
              <p>• Kargo ücreti, sepet tutarına göre belirlenir. Belirli tutarın üzerindeki siparişlerde kargo ücretsizdir.</p>
              <p>• Teslimat sırasında ürünlerin hasarlı olması durumunda, kargo firmasına tutanak tutturmanız gerekmektedir.</p>
              <p>• Teslimat adresi değişikliği için sipariş onayından önce bizimle iletişime geçebilirsiniz.</p>
            </div>
          </div>
