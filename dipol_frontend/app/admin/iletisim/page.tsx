            ...
            <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-md space-y-6">
              ...
              <div className="border-t pt-6">
                ...
                <div className="space-y-2 max-h-60 overflow-y-auto border rounded-lg p-4">
                  {allCategories
                    .filter((cat: any) => !cat.parent || !cat.parent._id) // Sadece ana kategoriler
                    .map((category: any) => {
                      ...
                      return (
                        <label
                          ...
                          className={`flex items-center space-x-2 p-2 rounded cursor-pointer ${
                            isSelected ? 'bg-primary/10' : canSelect ? 'hover:bg-gray-50' : 'opacity-50 cursor-not-allowed'
                          }`}
                        >
                          <input
                            type="checkbox"
                            ...
                            onChange={(e) => {
                              ...
                              if (e.target.checked) {
                                ...
                                setFormData({
                                  ...formData,
                                  featuredCategories: current.filter((id: string) => id !== category._id),
                                });
                              }
                            }}
                            className="rounded"
