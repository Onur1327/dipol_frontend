        ...
        <div>
                ...
                {product.sizes.map((size) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-5 py-3 border-2 rounded-lg font-semibold transition-all relative ${
                        isSelected
          ...
          <button
            onClick={handleAddToCart}
              ...
              className={`flex-1 py-4 rounded-lg font-semibold text-lg transition-colors ${
                !hasValidSelection || availableStock === 0
          ...
          >
            ...
            <button
              ...
              className={`px-6 py-4 rounded-lg font-semibold text-lg transition-colors border-2 ${
                isFavorite
