...
// IYZICO_URI environment variable ile override edilebilir
const IYZICO_URI = process.env.IYZICO_URI || (process.env.NODE_ENV === 'production' 
  ? 'https://api.iyzipay.com' 
  : 'https://sandbox-api.iyzipay.com');

// İyzico URI'yi export et (test için)
export const getIyzicoUri = () => IYZICO_URI;
